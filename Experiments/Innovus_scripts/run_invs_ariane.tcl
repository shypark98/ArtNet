...
set lefs "
    ...
    ${lefdir}/fakeram7_1024x39.lef \
    ${lefdir}/fakeram7_128x32.lef \
    ${lefdir}/fakeram7_128x50.lef \
    ${lefdir}/fakeram7_128x60.lef \
    ${lefdir}/fakeram7_160x118.lef \
    ${lefdir}/fakeram7_2048x42.lef \
    ${lefdir}/fakeram7_256x12.lef \
    ${lefdir}/fakeram7_256x32.lef \
    "
...
set pnr_clk_margin  __CLK_MARGIN__
set pdn_type        __PDN_TYPE__
set floorplan "util_${layout_util}_ar_${aspect_ratio}_rmax_${max_route_layer}_pdn_${pdn_type}_clk_${pnr_clk_margin}"
...
set sdc     ${net_dir}/${top_module}.sdc
...
floorplan -r 1 $layout_util 0.2 0.2 0.2 0.2
...
defOut -earlyGlobalRoute ${def_dir}/${top_module}_floorplan.def
